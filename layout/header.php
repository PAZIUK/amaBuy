				...
				<ul>
					<li>
						...
						<section class="toggleHeaderBtnsMenu">
							...
							?>
								<button link="index.php?action=addUser">Вхід / Реєстрація</button>
							<?php
								} else {
							?>
								<!-- <button link="index.php?action=me">Мій кабінет</button> -->
								<button link="index.php?action=addShopItem">Додати товар</button>
								<button link="index.php?action=myShop">Мої товари</button>
								<?php 
